# Support for Output Descriptors in Mobshed Core

Since Mobshed Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `shed1...` for mainnet or `tshed1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Mobshed's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Mobshed Core wallets, a convenience function `combo` is
