...
bech32_templates = [
  ...
  ('shed',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('shed',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('shed',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tshed',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tshed',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tshed',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rshed',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rshed',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rshed', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tshed',  17, 32, False, False, False),
  ('rshed',  3,  1, False, False, False),
  ('shed',   15, 41, False, False, False),
  ('tshed',  0, 16, False, False, False),
  ('rshed',  0, 32, True,  False, False),
  ('shed',   0, 16, True,  False, False),
  ('tshed',  0, 32, False, True,  False),
  ('rshed',  0, 20, False, False, True)
]
