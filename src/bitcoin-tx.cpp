...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mobshed-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mobshed-tx [options] <hex-tx> [commands]  Update hex-encoded mobshed transaction\n" +
            "or:     mobshed-tx [options] -create [commands]   Create hex-encoded mobshed transaction\n" +
            "\n";
