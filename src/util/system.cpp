...
const char * const BITCOIN_CONF_FILENAME = "mobshed.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mobshed";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mobshed";
#else
    // Unix
    return pathRet / ".mobshed";
#endif
#endif
}
