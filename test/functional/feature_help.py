...
"""Verify that starting mobshed with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mobshed with -h for help text")
        ...
        self.log.info("Start mobshed with -version for version information")
        ...
        self.log.info("Start mobshedd with -fakearg to make sure it does not start")
